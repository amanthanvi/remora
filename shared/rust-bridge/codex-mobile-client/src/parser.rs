...
fn normalize_review_path(path: &str) -> String {
    ...
    if let Some(remainder) = normalized.strip_prefix("//") {
        let remainder = collapse_repeated_slashes(remainder);
...
mod tests {
    ...
    fn parse_code_review_message_accepts_raw_json() {
        ...
        assert_eq!(
            ...
            Some(
                "/Users/remora/dev/remora/shared/rust-bridge/codex-mobile-client/src/mobile_client_impl.rs"
            )
        );
    ...
    fn normalize_review_path_matches_desktop_style() {
        ...
        assert_eq!(
            normalize_review_path("/Users/remora/dev/remora/src/main.rs"),
            "/Users/remora/dev/remora/src/main.rs"
        );
    }
