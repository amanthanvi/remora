...
pub(crate) use remote_content::exec_command_simple;
use remote_content::{WireFuzzyFileSearchResponse, resolve_image_view_bytes};
...
impl AppClient {
    ...
    //
    // Populated whenever remote runtime inspection succeeds. Platforms read
    // from here to render agent labels, icons,
    ...
    /// the remote host doesn't ship that agent.
