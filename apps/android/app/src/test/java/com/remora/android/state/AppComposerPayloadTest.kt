    ...
    fun turnStartParamsPrependsTextAndPreservesAdditionalInputs() {
        val payload =
            AppComposerPayload(
                ...
                additionalInputs =
                    listOf(
                        AppUserInput.Skill(name = "swiftui-pro", path = AbsolutePath("/Users/remora/.codex/skills/swiftui-pro/SKILL.md")),
        ...
        assertEquals("/Users/remora/.codex/skills/swiftui-pro/SKILL.md", skillInput.path.value)
