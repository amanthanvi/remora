 ...
 * the home screen can show the purchased remora without embedding BillingClient
 * plumbing themselves.
 *
...
object TipJarSupporterState {
    ...
    fun isHeaderRemoraSelected(productIds: List<String>): Boolean {
    ...
    fun setHeaderRemoraSelected(context: Context, productIds: List<String>, selected: Boolean) {
