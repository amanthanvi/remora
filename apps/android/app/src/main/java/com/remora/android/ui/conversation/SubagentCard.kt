...
fun SubagentCard(
    ...
    Column(
        ...
        Row(
            ...
            Text(
                text = actionLabel,
                color = RemoraTheme.toolCallCollaboration,
...
private fun statusColor(status: AppSubagentStatus?): Color {
    return when (status ?: AppSubagentStatus.UNKNOWN) {
        AppSubagentStatus.RUNNING -> RemoraTheme.accent
        AppSubagentStatus.COMPLETED -> RemoraTheme.success
        AppSubagentStatus.ERRORED -> RemoraTheme.danger
