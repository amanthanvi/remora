        ...
        LazyColumn(verticalArrangement = Arrangement.spacedBy(4.dp)) {
            ...
            item {
                Column(
                    ...
                    Text(
                        "If you enjoy Remora, consider leaving a tip. Tips help support ongoing development and are entirely optional.",
                ...
                is TipJarState.Ready -> {
                    ...
                    items(currentState.products) { tip ->
                        if (tip.isPurchased) {
                            ...
                            Row(
                                ...
                                Text(
                                    price,
                                    color = if (tip.details != null) RemoraTheme.accent else RemoraTheme.textSecondary,
                                    fontSize = 14.sp,
                                    fontWeight = FontWeight.SemiBold,
                                )
                            }
                        ...
                        items(purchasedTips, key = { "header-${it.productIds.first()}" }) { tip ->
                            ...
                            Row(
                                ...
                                modifier = Modifier
                                    ...
                                    .background(RemoraTheme.surface.copy(alpha = 0.6f), RoundedCornerShape(10.dp))
                                    .clickable {
                                        TipJarSupporterState.setHeaderRemoraSelected(
                                            context = context,
                                ...
                                Icon(
                                    ...
                                    tint = if (isSelected) RemoraTheme.accent else RemoraTheme.textMuted,
                                    modifier = Modifier
                                        .size(20.dp)
                    ...
                    item {
                        ...
                        TextButton(
                            ...
                            Text("Restore Purchases", color = RemoraTheme.accent, fontSize = 14.sp)
                        }
                    }
