...
object ExperimentalFeatures {
    private const val PREFS = "remora_ui_prefs"
    private const val KEY = "remora.experimentalFeatures"
    ...
    fun isEnabled(feature: RemoraFeature): Boolean {
        return overrides[feature.id] ?: feature.defaultEnabled
    }

    fun setEnabled(context: Context, feature: RemoraFeature, enabled: Boolean) {
