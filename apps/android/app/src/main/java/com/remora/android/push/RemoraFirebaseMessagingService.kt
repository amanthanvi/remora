package com.remora.android.push
...
import com.remora.android.state.latestAssistantSnippet
import com.remora.android.state.resolvedModel
import com.remora.android.state.resolvedPreview
    ...
    private suspend fun refreshTurnFromPush(data: Map<String, String>) {
        ...
        try {
            ...
            try {
                ...
                LLog.w(
                    "RemoraFirebaseMessagingService",
            ...
            if (thread == null) {
                LLog.i("RemoraFirebaseMessagingService", "Push wake refreshed but thread was unavailable")
                return
            }
            ...
            LLog.e("RemoraFirebaseMessagingService", "Push wake refresh failed", error)
        } finally {
            appModel.stop()
        }
    }
