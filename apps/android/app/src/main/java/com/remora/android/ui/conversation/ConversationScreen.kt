...
import com.remora.android.state.isActiveStatus
import com.remora.android.ui.BerkeleyMono
import com.remora.android.ui.ChatWallpaperBackground
...
fun ConversationScreen(
    ...
    val warmMarkwon = remember(context) {
        try {
            val prism4j = io.noties.prism4j.Prism4j(com.remora.android.ui.Prism4jGrammarLocator())
    ...
    val dismissedUserInputs = com.remora.android.ui.LocalDismissedUserInputs.current
    ...
    val headerScrimColor = if (hasWallpaper) RemoraTheme.surface.copy(alpha = 0.75f) else RemoraTheme.surface
        ...
        Column(
            ...
            Box(modifier = Modifier.weight(1f)) {
                if (thread == null) {
                    ...
                    val fadeColor = if (hasWallpaper) Color.Transparent else RemoraTheme.background
                                    ...
                                    Modifier.drawWithContent {
                                        ...
                                        drawRect(
                                            brush = Brush.verticalGradient(
                                                colors = listOf(RemoraTheme.background, Color.Transparent),
                                                startY = 0f,
                                                endY = 48f,
                                            ),
                                        )
                        ...
                        itemsIndexed(
                            ...
                            if (isExpanded) {
                                ...
                                Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                                    ...
                                    // Debug turn metrics
                                    if (com.remora.android.state.DebugSettings.enabled && com.remora.android.state.DebugSettings.showTurnMetrics) {
                ...
                Column(
                    ...
                    if (pinnedContext != null) {
                        Row(
                            modifier = Modifier
                                .fillMaxWidth()
                                .background(RemoraTheme.codeBackground.copy(alpha = if (hasWallpaper) 0.75f else 1f))
                    ...
                    run {
                        ...
                        if (voiceLocalSession != null && voicePhase != null) {
                            com.remora.android.ui.voice.InlineVoiceStatusStrip(
                                phase = voicePhase,
...
private fun MinigameLaunchButton(onClick: () -> Unit) {
    androidx.compose.material3.Surface(
        ...
        border = androidx.compose.foundation.BorderStroke(0.5.dp, RemoraTheme.accent.copy(alpha = 0.3f)),
