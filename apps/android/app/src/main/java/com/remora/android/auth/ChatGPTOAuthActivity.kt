...
import com.remora.android.state.ChatGPTOAuthTokenBundle
...
class ChatGPTOAuthActivity : ComponentActivity() {
    ...
    companion object {
        const val ACTION_BROWSER_RETURN = "com.remora.android.auth.CHATGPT_BROWSER_RETURN"
        ...
        Column(
            ...
            Text(
                text = if (browserOpened) {
                    ...
                    "Google blocks sign-in inside embedded web views, so Remora uses your browser for this flow."
                },
