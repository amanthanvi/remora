...
PATCH_FILES=(
    "$REPO_DIR/patches/codex/dependency-security-updates.patch"
    "$REPO_DIR/patches/codex/rmcp-test-server-host-validation.patch"
    "$REPO_DIR/patches/codex/rmcp-http-test-feature.patch"
