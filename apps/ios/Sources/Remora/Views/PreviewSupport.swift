...
enum RemoraPreviewData {
    static let sampleCwd = "/Users/remora/dev/codex-ios"
...
@MainActor
struct RemoraPreviewScene<Content: View>: View {
    ...
    init(
        ...
        _appModel = State(initialValue: appModel ?? RemoraPreviewData.makeConversationAppModel())
        _appState = State(initialValue: appState ?? RemoraPreviewData.makeAppState())
