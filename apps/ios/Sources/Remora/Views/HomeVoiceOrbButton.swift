...
struct HomeVoiceOrbButton: View {
    ...
    private var iconColor: Color {
        guard let phase else { return RemoraTheme.textSecondary }
        switch phase {
    ...
    private var strokeColor: Color {
        isActive ? iconColor.opacity(0.5) : RemoraTheme.textMuted.opacity(0.3)
    }
    ...
    var body: some View {
        ...
        .accessibilityHint("Starts a realtime voice conversation on the selected connected server.")
