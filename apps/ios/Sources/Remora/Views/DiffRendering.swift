...
private enum DiffSyntaxLineKind {
    ...
    var foregroundColor: UIColor {
        switch self {
        case .addition:
            return UIColor(RemoraTheme.success)
        case .deletion:
            return UIColor(RemoraTheme.danger)
        case .hunk:
            return UIColor(RemoraTheme.accentStrong)
        case .metadata:
            return UIColor(RemoraTheme.textSecondary)
        case .context:
            return UIColor(RemoraTheme.textBody)
        }
    }
    ...
    var backgroundColor: UIColor {
        switch self {
        case .addition:
            return UIColor(RemoraTheme.success).withAlphaComponent(0.12)
        case .deletion:
            return UIColor(RemoraTheme.danger).withAlphaComponent(0.12)
        case .hunk:
            return UIColor(RemoraTheme.accentStrong).withAlphaComponent(0.12)
        case .metadata:
            return UIColor(RemoraTheme.surface).withAlphaComponent(0.72)
        case .context:
            return UIColor(RemoraTheme.codeBackground).withAlphaComponent(0.72)
        }
    }
}
