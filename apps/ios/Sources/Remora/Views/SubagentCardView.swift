            ...
            HStack(alignment: .firstTextBaseline, spacing: 0) {
                ...
                if row.threadId != nil {
                    Button {
                        ...
                        Text("Open")
                            .remoraFont(.caption)
                            .foregroundColor(resolvedKey != nil ? RemoraTheme.textSecondary : RemoraTheme.textMuted)
                    }
                    .buttonStyle(.plain)
                }
            }
        ...
        NavigationStack {
            ...
            .toolbar {
                ToolbarItem(placement: .principal) {
                    ...
                    .remoraFont(.callout, weight: .semibold)
                }
        ...
        VStack(spacing: 20) {
            SubagentCardView(
                data: ConversationMultiAgentActionData(
                    tool: "spawnAgent",
                    status: .inProgress,
                    prompt: "Explore /Users/remora/dev/codex-app with a repo-orientation focus. Scan the top-level directories and identify the main modules.",
