...
struct WallpaperSelectionView: View {
        ...
        VStack(spacing: 12) {
            ...
            HStack {
                ...
                Text("Fix the login bug on the profile page")
                    ...
                    .padding(.horizontal, 14)
                    .padding(.vertical, 10)
                    .modifier(GlassRectModifier(cornerRadius: 14, tint: RemoraTheme.accent.opacity(0.3)))
            }
            .padding(.horizontal, 16)
    ...
    private var bottomCard: some View {
        ...
        .background(
            UnevenRoundedRectangle(topLeadingRadius: 20, topTrailingRadius: 20)
                .fill(RemoraTheme.surface.opacity(0.95))
        )
    }
    ...
    private var typingEffectSection: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            .overlay(RoundedRectangle(cornerRadius: 8, style: .continuous).stroke(RemoraTheme.border.opacity(0.6), lineWidth: 1))
            .padding(.horizontal, 16)
