...
struct LockScreenCardView: View {
    ...
    private var cardBackground: Color { RemoraPalette.surface.color(for: colorScheme) }
    private var logoBackground: Color { RemoraPalette.surfaceLight.color(for: colorScheme) }
    private var primaryText: Color { RemoraPalette.textPrimary.color(for: colorScheme) }
    private var secondaryText: Color { RemoraPalette.textSecondary.color(for: colorScheme) }
    private var tertiaryText: Color { RemoraPalette.textMuted.color(for: colorScheme) }
    ...
    private var dangerText: Color { RemoraPalette.danger.color(for: colorScheme) }
    private var warningText: Color { RemoraPalette.warning.color(for: colorScheme) }
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            HStack(alignment: .center, spacing: 10) {
                ...
                Text(prompt)
                    .font(.system(size: 13, weight: .medium, design: RemoraPalette.fontDesign))
            ...
            Text(displayText)
                .font(.system(size: 11, design: RemoraPalette.fontDesign))
