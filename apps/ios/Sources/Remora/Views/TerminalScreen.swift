...
struct TerminalScreen: View {
    ...
    @AppStorage("remora.terminal.fontSize") private var storedFontSize: Double = 13.0
    @AppStorage("remora.terminal.themeId") private var storedThemeId: String = "remora-dark"
    @AppStorage("remora.terminal.cursorBlink") private var storedCursorBlink: Bool = true
...
private enum TerminalThemeChoice: String, CaseIterable, Identifiable {
    ...
    var title: String {
        switch self {
        case .remoraDark: return "Remora Dark"
    ...
    var preset: TerminalThemePreset {
        switch self {
        case .remoraDark: return .remoraDark
    ...
    static func preset(forId id: String) -> TerminalThemePreset {
        (TerminalThemeChoice(rawValue: id) ?? .remoraDark).preset
    }
}
