...
final class AppState {
    ...
    private static let approvalPolicyKey = "remora.approvalPolicy"
    private static let sandboxModeKey = "remora.sandboxMode"
    private static let preferredModelKey = "remora.preferredModel"
    private static let preferredAgentRuntimeKindKey = "remora.preferredAgentRuntimeKind"
    private static let preferredReasoningEffortKey = "remora.preferredReasoningEffort"
