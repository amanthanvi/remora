...
enum ChatGPTOAuthError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .callbackTimedOut:
            return "ChatGPT login timed out before returning to Remora."
        case .missingRefreshToken:
...
final class ChatGPTOAuthTokenStore {
    ...
    private let service = "com.remora.app.chatgpt.tokens"
...
private final class ChatGPTOAuthLoopbackServer: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "com.remora.app.chatgpt-oauth")
