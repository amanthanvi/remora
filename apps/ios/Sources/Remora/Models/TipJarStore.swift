...
final class TipJarStore {
    ...
    private static let selectedHeaderTierIDsKey = "support.selectedHeaderTierIDs"
    ...
    func isHeaderBadgeSelected(_ tier: TipTier) -> Bool {
    ...
    func setHeaderBadge(_ tier: TipTier, selected: Bool) {
