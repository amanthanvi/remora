...
typedef void (^RemoraGhosttyInputHandler)(NSData *data);
...
@interface RemoraGhosttyTerminal : NSObject

@property (nonatomic, copy, nullable) RemoraGhosttyInputHandler inputHandler;
...
typedef NS_ENUM(int, RemoraGhosttyKey) {
    RemoraGhosttyKeyUnidentified = 0,
    RemoraGhosttyKeyEnter,
    RemoraGhosttyKeyTab,
    RemoraGhosttyKeyBackspace,
    RemoraGhosttyKeyEscape,
    RemoraGhosttyKeySpace,
    RemoraGhosttyKeyArrowUp,
    RemoraGhosttyKeyArrowDown,
    RemoraGhosttyKeyArrowLeft,
    RemoraGhosttyKeyArrowRight,
    RemoraGhosttyKeyPageUp,
    RemoraGhosttyKeyPageDown,
    RemoraGhosttyKeyHome,
    RemoraGhosttyKeyEnd,
    RemoraGhosttyKeyDelete,
    RemoraGhosttyKeyInsert,
};

// Key dispatch. `action` 0=release, 1=press, 2=repeat.
// `key` is a `RemoraGhosttyKey` from the table above; the bridge translates
