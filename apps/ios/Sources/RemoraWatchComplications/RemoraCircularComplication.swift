...
struct RemoraCircularComplication: Widget {
    let kind = "RemoraCircularComplication"
    ...
    var body: some WidgetConfiguration {
        AppIntentConfiguration(
            ...
            RemoraCircularView(entry: entry)
                .widgetAccentable()
...
struct RemoraCircularView: View {
...
#Preview(as: .accessoryCircular) {
    ...
    RemoraComplicationEntry.idlePlaceholder
}
